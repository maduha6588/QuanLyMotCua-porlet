...
public class FooWrapper implements Foo, ModelWrapper<Foo> {
	...
	*/
	...
	@Override
	public int compareTo(com.hamd.quanlymotcua.model.Foo foo) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.hamd.quanlymotcua.model.Foo> toCacheModel() {
		return _foo.toCacheModel();
	}

	@Override
	public com.hamd.quanlymotcua.model.Foo toEscapedModel() {
		return new FooWrapper(_foo.toEscapedModel());
	}

	@Override
	public com.hamd.quanlymotcua.model.Foo toUnescapedModel() {
