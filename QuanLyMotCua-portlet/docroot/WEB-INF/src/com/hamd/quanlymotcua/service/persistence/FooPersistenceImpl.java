...
import com.hamd.quanlymotcua.NoSuchFooException;
import com.hamd.quanlymotcua.model.Foo;
import com.hamd.quanlymotcua.model.impl.FooImpl;
import com.hamd.quanlymotcua.model.impl.FooModelImpl;
...
public class FooPersistenceImpl extends BasePersistenceImpl<Foo>
	...
	@Override
	public Foo updateImpl(com.hamd.quanlymotcua.model.Foo foo)
		throws SystemException {
		foo = toUnwrappedModel(foo);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.hamd.quanlymotcua.model.Foo")));
